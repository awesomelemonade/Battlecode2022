...
public class Archon implements RunnableBot {
    ...
    public void loop() throws GameActionException {
        ...
        int opminermicro3 = Communication.getSoldierCombinedHealth();
        if (numMiners == 0) {
            averageIncome = 0;
        ...
        Debug.setIndicatorString("B: " + numBuilders + ", M: " + numMiners + ", S: " + numSoldiers + ", W: " + numWatchtowers + ", H: " + opminermicro3 + ", I: " + averageIncome + ", I/M " + (averageIncome / numMiners));
