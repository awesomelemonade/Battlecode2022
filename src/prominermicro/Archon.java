...
public class Archon implements RunnableBot {
    ...
    public void loop() throws GameActionException {
        ...
        int prominermicro = Communication.getSoldierCombinedHealth();
        if (numMiners == 0) {
            averageIncome = 0;
        ...
        Debug.setIndicatorString("A: " + numArchons + ", M: " + numMiners + ", S: " + numSoldiers + ", W: " + numWatchtowers + ", H: " + prominermicro + ", I: " + averageIncome + ", I/M " + (averageIncome / numMiners));
