...
import static opsoldiermicro2.util.Constants.*;
...
public class Archon implements RunnableBot {
    ...
    public void loop() throws GameActionException {
        ...
        int opsoldiermicro2 = Communication.getSoldierCombinedHealth();
        if (numMiners == 0) {
            averageIncome = 0;
        ...
        Debug.setIndicatorString("B: " + numBuilders + ", M: " + numMiners + ", S: " + numSoldiers + ", W: " + numWatchtowers + ", H: " + opsoldiermicro2 + ", I: " + averageIncome + ", I/M " + (averageIncome / numMiners));
