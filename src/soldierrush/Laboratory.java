...
import soldierrush.util.*;

import static soldierrush.util.Constants.ALLY_TEAM;
...
public class Laboratory implements RunnableBot {
    ...
    public void loop() throws GameActionException {
        if (rc.getMode() == RobotMode.TURRET) {
            ...
            if (rc.getTeamLeadAmount(ALLY_TEAM) - rc.getTransmutationRate() >= RobotType.MINER.buildCostLead) {
                if (rc.canTransmute()) {
                    rc.transmute();
                }
            } else {
