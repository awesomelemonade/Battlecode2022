...
// START BOUNDED: minX=0, maxX=4, minY=0, maxY=4
        ...
        score_2_1 = dp_2_1 + rubble_2_1 + Math.sqrt(loc_2_1.distanceSquaredTo(target)) * 8.0;
        if (score_2_1 < bestScore) {
            bestScore = score_2_1;
            bestDir = dir_2_1;
        }
        ...
        score_1_2 = dp_1_2 + rubble_1_2 + Math.sqrt(loc_1_2.distanceSquaredTo(target)) * 8.0;
        if (score_1_2 < bestScore) {
            bestScore = score_1_2;
            bestDir = dir_1_2;
        }
        ...
        score_1_3 = dp_1_3 + rubble_1_3 + Math.sqrt(loc_1_3.distanceSquaredTo(target)) * 8.0;
        if (score_1_3 < bestScore) {
            bestScore = score_1_3;
            bestDir = dir_1_3;
        }
        score_1_4 = dp_1_4 + rubble_1_4 + Math.sqrt(loc_1_4.distanceSquaredTo(target)) * 8.0;
        if (score_1_4 < bestScore) {
            bestScore = score_1_4;
            bestDir = dir_1_4;
        }
        score_4_1 = dp_4_1 + rubble_4_1 + Math.sqrt(loc_4_1.distanceSquaredTo(target)) * 8.0;
        if (score_4_1 < bestScore) {
            bestScore = score_4_1;
            bestDir = dir_4_1;
        }
        ...
        score_3_1 = dp_3_1 + rubble_3_1 + Math.sqrt(loc_3_1.distanceSquaredTo(target)) * 8.0;
        if (score_3_1 < bestScore) {
            bestScore = score_3_1;
            bestDir = dir_3_1;
        }
        return bestDir;
...
// START BOUNDED: minX=1, maxX=6, minY=0, maxY=5
        ...
        score_2_5 = dp_2_5 + rubble_2_5 + Math.sqrt(loc_2_5.distanceSquaredTo(target)) * 8.0;
        if (score_2_5 < bestScore) {
            bestScore = score_2_5;
            bestDir = dir_2_5;
        }
        score_3_5 = dp_3_5 + rubble_3_5 + Math.sqrt(loc_3_5.distanceSquaredTo(target)) * 8.0;
        if (score_3_5 < bestScore) {
            bestScore = score_3_5;
            bestDir = dir_3_5;
        }
        ...
        score_4_5 = dp_4_5 + rubble_4_5 + Math.sqrt(loc_4_5.distanceSquaredTo(target)) * 8.0;
        if (score_4_5 < bestScore) {
            bestScore = score_4_5;
            bestDir = dir_4_5;
        }
        ...
        score_5_4 = dp_5_4 + rubble_5_4 + Math.sqrt(loc_5_4.distanceSquaredTo(target)) * 8.0;
        if (score_5_4 < bestScore) {
            bestScore = score_5_4;
            bestDir = dir_5_4;
        }
        score_5_3 = dp_5_3 + rubble_5_3 + Math.sqrt(loc_5_3.distanceSquaredTo(target)) * 8.0;
        if (score_5_3 < bestScore) {
            bestScore = score_5_3;
            bestDir = dir_5_3;
        }
        score_5_2 = dp_5_2 + rubble_5_2 + Math.sqrt(loc_5_2.distanceSquaredTo(target)) * 8.0;
        if (score_5_2 < bestScore) {
            bestScore = score_5_2;
            bestDir = dir_5_2;
        }
