...
public class Generated13 {
    ...
    public static boolean onTheMap_1_0;
    ...
    public static boolean onTheMap_0_1;
    ...
    public static Direction execute(MapLocation target) throws GameActionException {
        ...
        onTheMap_1_0 = rc.onTheMap(loc_1_0);
        if (onTheMap_1_0) {
        ...
        onTheMap_0_1 = rc.onTheMap(loc_0_1);
        if (onTheMap_0_1) {
        ...
        double next_5_5 = dp_5_5 + rubble_5_5;
        if (onTheMap_5_6) {
            if (next_5_5 < dp_5_6) {
                dp_5_6 = next_5_5;
                dir_5_6 = dir_5_5;
        ...
        double next_0_2 = dp_2_0 + rubble_2_0;
        if (onTheMap_1_0) {
            if (next_0_2 < dp_1_0) {
                dp_1_0 = next_0_2;
                dir_1_0 = dir_2_0;
        ...
        double next_2_0 = dp_0_2 + rubble_0_2;
        if (onTheMap_0_1) {
            if (next_2_0 < dp_0_1) {
                dp_0_1 = next_2_0;
                dir_0_1 = dir_0_2;
        ...
        if (onTheMap_1_0) {
            double score = dp_1_0 + rubble_1_0 + Math.sqrt(loc_1_0.distanceSquaredTo(target)) * 8.0;
            if (score < bestScore) {
                bestScore = score;
                bestDir = dir_1_0;
            }
        ...
        if (onTheMap_0_1) {
            double score = dp_0_1 + rubble_0_1 + Math.sqrt(loc_0_1.distanceSquaredTo(target)) * 8.0;
            if (score < bestScore) {
                bestScore = score;
                bestDir = dir_0_1;
            }
        ...
        if (onTheMap_2_6) {
            double score = dp_2_6 + rubble_2_6 + Math.sqrt(loc_2_6.distanceSquaredTo(target)) * 8.0;
            if (score < bestScore) {
                bestScore = score;
                bestDir = dir_2_6;
            }
        ...
        if (onTheMap_4_6) {
            double score = dp_4_6 + rubble_4_6 + Math.sqrt(loc_4_6.distanceSquaredTo(target)) * 8.0;
            if (score < bestScore) {
                bestScore = score;
                bestDir = dir_4_6;
            }
        ...
        if (onTheMap_5_6) {
            double score = dp_5_6 + rubble_5_6 + Math.sqrt(loc_5_6.distanceSquaredTo(target)) * 8.0;
            if (score < bestScore) {
                bestScore = score;
                bestDir = dir_5_6;
            }
        ...
        if (onTheMap_6_5) {
            double score = dp_6_5 + rubble_6_5 + Math.sqrt(loc_6_5.distanceSquaredTo(target)) * 8.0;
            if (score < bestScore) {
                bestScore = score;
                bestDir = dir_6_5;
            }
        ...
        if (onTheMap_6_4) {
            double score = dp_6_4 + rubble_6_4 + Math.sqrt(loc_6_4.distanceSquaredTo(target)) * 8.0;
            if (score < bestScore) {
                bestScore = score;
                bestDir = dir_6_4;
            }
        ...
        if (onTheMap_6_2) {
            double score = dp_6_2 + rubble_6_2 + Math.sqrt(loc_6_2.distanceSquaredTo(target)) * 8.0;
            if (score < bestScore) {
                bestScore = score;
                bestDir = dir_6_2;
            }
