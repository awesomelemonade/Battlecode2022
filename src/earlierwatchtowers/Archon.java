...
import earlierwatchtowers.util.*;

import static earlierwatchtowers.util.Constants.*;
...
public class Archon implements RunnableBot {
    ...
    public void loop() throws GameActionException {
        ...
        int earlierwatchtowers = Communication.getSoldierCombinedHealth();
        if (numMiners == 0) {
            averageIncome = 0;
        ...
        Debug.setIndicatorString("B: " + numBuilders + ", M: " + numMiners + ", S: " + numSoldiers + ", W: " + numWatchtowers + ", H: " + earlierwatchtowers + ", I: " + averageIncome + ", I/M " + (averageIncome / numMiners));
